    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true){
            ...
            switch (optiune) {
                ...
                case 2 -> System.out.println("Introduceti un student nou si inrolati-l la curs");
                case 3 -> System.out.println("Introduceti un curs nou");
                case 4 -> System.out.println("Cautati un student dupa nume (OPTIONAL)");
